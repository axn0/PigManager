...
const abilityOptions: { [key: string]: string } = {
    black: "Strength: ",
    chestnut: "Language: ",
    grey: "Swimming: ",
    white: "Running: "
...
const abilityInput = document.getElementById("ability") as HTMLInputElement;
...
const form = document.querySelector(".new-pig-form") as HTMLFormElement;
...
const personality = document.querySelector("#personality") as HTMLInputElement;
const category = document.querySelector("#category") as HTMLSelectElement;
const breed = document.querySelector("#breed") as HTMLSelectElement;
const ability = document.querySelector("#ability") as HTMLInputElement;
...
form.addEventListener("submit", (e:Event) => {
    ...
    if (!validateForm()) {
        ...
        if (pigData) {
            old_data = JSON.parse(pigData).map((item: any) => {
        ...
        old_data.sort((a: ThePig, b: ThePig) => {
